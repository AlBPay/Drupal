...
class Fondy extends PaymentMethodPluginBase implements OffsitePaymentMethodPluginInterface {
	 ...
	 */
	protected $url = 'https://payment.albpay.io/api/checkout/redirect/';
	/**
	 * @var string
	 */
	...
	public function buildConfigurationForm( array $form, FormStateInterface $form_state ) {
		...
		$form['secret_key']  = array(
			...
			'#description'   => $this->t( 'The secret word entered in your Alliance bank settings page.' ),
		...
		$form['language']    = array(
			...
			'#description'   => $this->t( 'Adjust language on Alliance bank pages.' ),
			'#options'       => array(
				'en' => $this->t( 'English' ),
				'ru' => $this->t( 'Russian' ),
				'ua' => $this->t( 'Ukranian' ),
	...
	public function cartReviewTitle() {
		return $this->t( 'Credit card Alliance bank' );
	}
